...
const Experience = () => {
    return (
        <section id="experience">
             <h2>EXPERIENCE</h2>
             <p className='experinceContent'>I've been designing and building apps for about 2 years now, and I'm always eager to learn more in this fast paced industry.</p>
